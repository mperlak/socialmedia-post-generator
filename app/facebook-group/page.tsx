...
import { ArrowLeft, Users, Upload, ImageIcon, FileText, Sparkles, Loader2 } from "lucide-react"
...
export default function FacebookGroupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-mroomy-blue/10 to-mroomy-green/10">
      {/* Header */}
      <header className="border-b border-border/40 bg-card/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-bold text-2xl text-foreground">Grupa Facebook</h1>
              <p className="text-sm text-muted-foreground">Cykl "Mroomy Rozwiązuje" - merytoryczny case study</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto space-y-8">
          {/* Info Card */}
          <Card className="border-2 border-mroomy-blue/30 bg-gradient-to-br from-card to-mroomy-blue/5">
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-mroomy-blue/10 flex items-center justify-center">
                  <Users className="w-5 h-5 text-mroomy-blue" />
                </div>
                <div>
                  <CardTitle className="text-xl">Merytoryczny case study</CardTitle>
                  <CardDescription className="mt-1">Post edukacyjny pokazujący proces projektowania</CardDescription>
                </div>
              </div>
            </CardHeader>
          </Card>
              ...
              {images.length > 0 ? (
                ...
                <label className="block">
                  ...
                  <div
                    ...
                    className={`border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-all ${
                      isDraggingImages
                        ? 'border-mroomy-green bg-mroomy-green/10 scale-105'
                        : 'border-border hover:border-mroomy-green/50 hover:bg-mroomy-green/5'
                    }`}
                  >
                    <div className="space-y-2">
                      <div className="w-12 h-12 rounded-xl bg-muted flex items-center justify-center mx-auto">
          ...
          <Button
            size="lg"
            className="w-full h-14 text-lg font-bold bg-mroomy-blue hover:bg-mroomy-blue/90 text-white rounded-xl shadow-lg hover:shadow-xl transition-all"
